                    ...
                    <nav role="navigation" className="nav-menu w-nav-menu w--nav-menu-open">
                        ...
                        {this.props.isAdmin() && (
                            <section>
                                ...
                                <a href="/AddUser" className="nav-link w-nav-link w--nav-link-open">Add User</a>
                                <div className="neon-green-line tiny center"></div>
                                <a href="/Defaults" className="nav-link w-nav-link w--nav-link-open">Set Defaults</a>
                                <div className="neon-green-line tiny center"></div>
                                <a className="nav-link w-nav-link w--nav-link-open" href="/Csv">Export to CSV</a>
                                <div className="neon-green-line tiny center"></div>
                            </section>
                        )}
                        {this.props.isAuthenticated() && (
                            <section>                                                                
                                <a className="nav-link w-nav-link w--nav-link-open" onClick={()=>{
                                    this.props.logOut();
