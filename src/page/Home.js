...
export default class Home extends Component {
  ...
  delete = async () => {
    if (window.confirm("Are you sure you want to delete this?")) {
      ...
      if (xray && xray.value) {
        ...
        if (xray.value.LeftFrog || xray.value.RightFrog) FrogEval = false;
        ...
        this.setState({
          ...
          isLoading: false,
          EvalType,
          leftSide: xray.value.Hip,
          rightSide: xray.value.Hip,
          activeSide,
          FrogEval,
          left,
        });
  ...
  FrogView = () => {
    ...
    this.setState({
      ...
      activeSide,
      left,
      leftSide: xray.value.LeftFrog,
      rightSide: xray.value.RightFrog,
      EvalType: "Frog",
    });
  };
        ...
        <div className="columns-6 w-row">
          ...
          <div className="w-col w-col-5">
            <p className="small-paragraph">
              Patient Reference Number: {xray.value.RefNum}
            </p>
          </div>
        </div>
        {isLoading ? (
          ...
          <div>
            <div className="columns-2 w-row">
              ...
              {this.state.activeSide === "Right" ? (
                <span style={{ width: "50%" }}>
                  <Zoom
                    src={getImageFromObject(xray.value.HipImage.imageUrl)}
                    style={{
                      width: "98%",
                      height: "200px",
                      marginRight: 0,
              ...
              this.state.activeSide === "Right" ? (
                <span style={{ width: "50%" }}>
                  <Zoom
                    src={getImageFromObject(xray.value.RightFrogImage.imageUrl)}
                    style={{
                      width: "98%",
                      height: "200px",
                      marginRight: 0,
            ...
            <div>
              {this.state.rightSide ? (
                ...
                >
                  Right {this.state.EvalType}
                </a>
              ) : null}
              {this.state.leftSide ? (
                <a
                  className="button-confirm w-button"
                  onClick={this.leftHip}
                  style={{
                    marginLeft: 30,
                    borderWidth: lB ? 3 : 0,
                    borderColor: lB ? "white" : "none",
                      ...
                      {i.value < 5 ? (
                        <td>
                          <CheckBox
                            ...
                            default={xray.value.d_rightMedial === i.value}
                            onChange={(checked) => {
                              this.handleCheck(checked, "zone1", i.value);
                            }}
                          />
                        </td>
                      ) : (
                      ...
                      {i.value < 5 ? (
                        <td>
                          <CheckBox
                            ...
                            default={xray.value.d_rightMedial === i.value}
                            onChange={(checked) => {
                              this.handleCheck(checked, "zone2", i.value);
                            }}
                          />
                        </td>
                      ) : (
                        <td>
                          <CheckBox
                            ...
                            default={xray.value.d_rightLateral === i.value}
                            onChange={(checked) => {
                              this.handleCheckAll(checked, i.value);
                            }}
                          />
                        </td>
                      )}
                      {i.value < 5 ? (
                        <td>
                          <CheckBox
                            ...
                            default={xray.value.d_leftMedial === i.value}
                            onChange={(checked) => {
                              this.handleCheck(checked, "zone3", i.value);
                            }}
                          />
                        </td>
                      ) : (
            ...
            <a
              ...
              style={{ position: "fixed", left: "auto", right: 50, bottom: 20 }}
            >
              {" "}
              Next{" "}
            </a>
