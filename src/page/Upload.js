...
export default class Upload extends Component {
  ...
  uploadHanlder = async () => {
    ...
    for (let i = 0; i < afterUpload.length; i++) {
      ...
      if (file.isUploading) {
        ...
        console.log(refnum);
        UniImagesObject[refnum] = {
          RefNum: refnum,
          HipImage: {},
          leftNotes: "",
          rightNotes: "",
          userName: "Not Evaluated",
          LeftHipImage: {},
          RightHipImage: {},
          LeftFrogImage: {},
          RightFrogImage: {},
            ...
            UploadImage(afterUpload[j].file)
              .then((url) => {
                ...
                if (afterUpload[j].name.match(/Pelvis/gi) != null) {
                  ...
                  UniImagesObject[refnum].HipImage = {
                    imageUrl: "",
                    ImageName: "",
                  };
                  UniImagesObject[refnum].LeftHipImage = {
                    zone1: "",
                    zone2: "",
                    zone3: "",
                  };
                  UniImagesObject[refnum].RightHipImage = {
                    zone1: "",
                    zone2: "",
                    zone3: "",
                  };
                  ...
                  UniImagesObject[refnum].HipImage.ImageName =
                    afterUpload[j].name;
                }
                ...
                // }
                  ...
                  UniImagesObject[refnum].LeftFrogImage = {
                    comment: "",
                    imageUrl: "",
                    zone1: "",
                    zone2: "",
                  ...
                  UniImagesObject[refnum].RightFrogImage.ImageName =
                    afterUpload[j].name;
                } else {
  ...
  uploadImagesObject = () => {
    ...
    for (let [key, value] of Object.entries(UniImagesObject)) {
      ...
      if (
        value.LeftFrog == false &&
        value.RightFrog == false &&
        value.Hip == false
      ) {
        alert(
          "No Relevant Image Found at ref: " +
            value.RefNum +
            " or Patient Data already Exist"
        );
        ...
        for (var i = 1; i < csv.length; i++) {
          if (csv[i].length === 17) {
            ...
            if (csv[i][1].match(/Pelvis/gi) != null) {
              ...
              await setPelvisDefaults(
                refnum,
                leftZone1 ? leftZone1.value : "",
                leftZone2 ? leftZone2.value : "",
                leftZone3 ? leftZone3.value : "",
                rightZone1 ? rightZone1.value : "",
                rightZone2 ? rightZone2.value : "",
                rightZone3 ? rightZone3.value : ""
              );
          ...
          <div id="react-file-drop-demo" className="drop-zone">
            <FileDrop onDrop={this.handleDrop}>
              ...
              <div className="absolute-bottom">
                <span className="small-title">Or click &nbsp;</span>
                <button
                  className="button-confirm w-button"
                  onClick={() => {
                    if (upload == false) {
                ...
                <span className="small-title">
                  {" "}
                  &nbsp; to select X-ray files
                </span>
                <input
                  type="file"
                  id="slFile"
                  className="button-confirm hide"
                  accept=".png,.jpg,.jpeg"
                  multiple={true}
                  onChange={(e) => {
          ...
          <div className="column-5 w-col w-col-12">
            {!this.state.process && (
              <section>
                ...
                {this.state.process && (
                  <span className="small-title">Processing CSV...</span>
                )}
                <span style={{ float: "right" }}>
                  <button
                    className="button-confirm w-button"
                    style={{ opacity: this.state.upload ? "1" : "0.5" }}
                    onClick={this.uploadHanlder}
                  >
                    Upload
                  </button>
                </span>
            ...
            <CSVReader
              ...
              label=""
              onFileLoaded={this.handleDefault}
              onError={() => {
                console.log("error");
              }}
              inputId="slCsv"
